...
(function () {
    ...
    form.addEventListener("submit", (e) => {
        ...
        // Kiểm tra với UserManager nếu có
        if (window.UserManager) {
            const result = window.UserManager.loginUser(u, p);

            if (result.success) {
                // Lưu thông tin user vào auth_user để tương thích với các trang khác
        ...
        // Fallback: Demo auth cũ (user / 12345678)
